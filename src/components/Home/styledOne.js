...
export const MainContainer = styled.div`
  background-color: ${props => (props.isLight ? '#ffffff' : '#181818')};
  display: flex;
  height: 95vh;
`
...
export const IconCont = styled.li`
  ...
  color: ${props => (props.one === 'true' ? 'red' : null)};

  background-color: ${props => (props.one === 'true' ? '#e2e8f0' : null)};
  border-radius: 4px;
  display: flex;
  align-items: center;
  padding: 8px 0px;
...
export const MainHeadings = styled.h1`
  color: ${props => (props.isLight ? '#35383f' : '#f1f1f1')};
  color: ${props => (props.one === 'true' ? '#080808' : null)};
  font-size: 12px;
  font-weight: 500;
  margin: 0px;
  padding: 0px;
